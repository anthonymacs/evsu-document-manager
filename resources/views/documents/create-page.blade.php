        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            @csrf
                    ...
                    @if($categories->isEmpty())
                        ...
                        <div class="flex items-start gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-xl mb-2">
                            ...
                            <p class="text-xs text-yellow-700">
                                ...
                                <a href="{{ route('categories.create') }}" class="underline font-semibold">Create one first →</a>
                            </p>
                        </div>
                    @endif
                ...
                <div class="flex gap-3 pt-2">
                    <button type="submit"
                        class="flex-1 bg-university-red text-white py-2.5 rounded-xl text-sm font-semibold hover:opacity-90 transition shadow-sm {{ $categories->isEmpty() ? 'opacity-50 cursor-not-allowed' : '' }}"
                        {{ $categories->isEmpty() ? 'disabled' : '' }}>
                        ✅ Log Submission
                    </button>
                    <a href="{{ route('documents.index') }}"
                    ...
                    <div class="flex justify-between text-xs mb-1.5">
                        <span class="text-gray-600 font-medium flex items-center gap-1.5">
                            ...
                            @if($cat->status !== 'active')
                                <span class="text-gray-400 font-normal">(inactive)</span>
                            @endif
                        </span>
